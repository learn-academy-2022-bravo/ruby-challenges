...
# class Task
#   def initialize status_param = 'incomplete'
#   @task_done = [status_param]
#   end
#   def task_done
#     @task_done
#   end
# end
#
# laundry = Task.new('done')
# laundry.task_done
# p laundry
# sweep = Task.new('done')
# sweep.task_done
# p sweep
# dishes = Task.new('done')
# dishes.task_done
# p dishes
...
class ColorPalette
  ...
  def initialize(color1_param, color2_param, color3_param)
    @color1_param = color1_param
    @color2_param = color2_param
    @color3_param = color3_param
  end

    def all_colors (color1_param, color2_param, color3_param)
      p "the three colors are #{color1_param}, #{color2_param}, and #{color3_param}"
    end
  end


green = ColorPalette.new('Seafoam', 'Forest', 'Kelly')
green
red = ColorPalette.new('Wine', 'Crimson', 'Ruby Red')
red
blue = ColorPalette.new("Aqua", "Navy", "Indigo")
blue

p green.color1_param
p red.color2_param
p blue.color3_param
