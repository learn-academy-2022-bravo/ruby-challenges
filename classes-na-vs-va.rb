...
# cleaned_dishes = Task.new
# cooked_dinner = Task.new
# mopped_floors = Task.new
...
class Task
    def initialize (title_param, status_param)
      @title = title_param
      @status = status_param
    end
    def get_title
...
cleaned_dishes = Task.new('Dishes', 'Incomplete')
cooked_dinner = Task.new('Cooked dinner', 'Incomplete')
mopped_floors = Task.new('Mopped floors', 'Incomplete')

p cleaned_dishes.begin_task
p cooked_dinner.begin_task
p mopped_floors.begin_task

p cleaned_dishes.end_task
p cooked_dinner.end_task
p mopped_floors.end_task
